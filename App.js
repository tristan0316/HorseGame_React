...
//   useEffect(() => {
//     console.log('SETVALUE_______', value)
...
//           console.log("Prev Mile1" , value)
//           setValue(mile1+RandomNumber1);
//           console.log("After Mile1: " ,value)
//            }
...
const App = () => {
  ...
  useEffect(() => {
    console.log("miles updated",mile1)
  ...
  const run =() =>{ 
          setInterval(() => {
            // if(mile1<1){
              var RandomNumber1 = Math.floor(Math.random() * 100)*0.001  ;
              console.log("Random " + RandomNumber1)
              console.log("Prev Mile1" , mile1)
              setMile1(mile1+RandomNumber1);
              console.log("After Mile1: " ,mile1)
              //  }
...
return(
  <View>
    <Text onPress={() => run()}> APPP {mile1}</Text>
  </View>)
